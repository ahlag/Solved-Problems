...
int main() {
    ...
    cout << "Approach 1:" << solution.isPermutationOfPallindrome1( str ) << endl;
    cout << "Approach 2:" << solution.isPermutationOfPallindrome2( str ) << endl;
    cout << "Approach 3:" << solution.isPermutationOfPallindrome3( str ) << endl;


    string str1("A big Cat");
    cout << "Does \"" << str1 << "\" has a string whose permutation is a pallindrome? "
              << "( 1 for true, 0 for false ) : ";
    cout << "Approach 1:" << solution.isPermutationOfPallindrome1( str1 ) << endl;
    cout << "Approach 2:" << solution.isPermutationOfPallindrome2( str1 ) << endl;
    cout << "Approach 3:" << solution.isPermutationOfPallindrome3( str1 ) << endl;


    string str2("Aba cbc");
    cout << "Does \"" << str2 << "\" has a string whose permutation is a pallindrome? "
              << "( 1 for true, 0 for false ) : ";
    cout << "Approach 1:" << solution.isPermutationOfPallindrome1( str2 ) << endl;
    cout << "Approach 2:" << solution.isPermutationOfPallindrome2( str2 ) << endl;
    cout << "Approach 3:" << solution.isPermutationOfPallindrome3( str2 ) << endl;
    return 0;
}